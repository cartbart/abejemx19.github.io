...
//Button listener for colors
document.getElementById("Colorss").onclick = function () {
    color = vec4(1.0, 0.0, 0.0, 1.0);

};
document.getElementById("Colorss1").onclick = function () {
    color = vec4(0.0, 1.0, 0.0, 1.0);

};

document.getElementById("Colorss2").onclick = function () {
    color = vec4(0.0, 0.0, 1.0, 1.0);

};

document.getElementById("Colorss3").onclick = function () {
    color = vec4(1.0, 1.0, 0.0, 1.0);
